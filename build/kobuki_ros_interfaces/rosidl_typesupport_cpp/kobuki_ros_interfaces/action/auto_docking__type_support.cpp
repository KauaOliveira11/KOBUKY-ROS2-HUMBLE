...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, kobuki_ros_interfaces, action, AutoDocking_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<kobuki_ros_interfaces::action::AutoDocking_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, kobuki_ros_interfaces, action, AutoDocking_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<kobuki_ros_interfaces::action::AutoDocking_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, kobuki_ros_interfaces, action, AutoDocking)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<kobuki_ros_interfaces::action::AutoDocking>();
}
